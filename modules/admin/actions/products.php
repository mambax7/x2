...
switch($action) {
	...
	// ****************************************************************************************************************
		...
		if(oledrion_utils::getModuleOption('product_property1')) {
	      $property1select = new XoopsFormSelect(_AM_OLEDRION_PRODUCT_PROPERTY1, 'product_property1', $item->getVar('product_property1'));
      ...
      if(oledrion_utils::getModuleOption('product_property2')) {
	      $property2select = new XoopsFormSelect(_AM_OLEDRION_PRODUCT_PROPERTY2, 'product_property2', $item->getVar('product_property2'));
      ...
      if(oledrion_utils::getModuleOption('product_property3')) {
	      $property3select = new XoopsFormSelect(_AM_OLEDRION_PRODUCT_PROPERTY3, 'product_property3', $item->getVar('product_property3'));
      ...
      if(oledrion_utils::getModuleOption('product_property4')) {
	      $property4select = new XoopsFormSelect(_AM_OLEDRION_PRODUCT_PROPERTY4, 'product_property4', $item->getVar('product_property4'));
      ...
      if(oledrion_utils::getModuleOption('product_property5')) {
	      $property5select = new XoopsFormSelect(_AM_OLEDRION_PRODUCT_PROPERTY5, 'product_property5', $item->getVar('product_property5'));
