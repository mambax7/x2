...
// Tables cr�e depuis le fichier sql
...
$i++;
$modversion['config'][$i]['name']        = 'purgelimit';
$modversion['config'][$i]['title']       = '_MI_TDMDOWNLOADS_LIMITPURGE';
$modversion['config'][$i]['description'] = '_MI_TDMDOWNLOADS_LIMITPURGEDSC';
$modversion['config'][$i]['formtype']    = 'yesno';
$modversion['config'][$i]['valuetype']   = 'int';
$modversion['config'][$i]['default']     = 0;
$i++;
