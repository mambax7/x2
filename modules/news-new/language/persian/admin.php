...
define('_NEWS_AM_TOPIC_SHOWSUB','نمایش فهرست زیر شاخه');
...
// Content page
define('_NEWS_AM_STORY_FORM','مدیریت اخبار');
define('_NEWS_AM_STORY_FORMTITLE','عنوان');
define('_NEWS_AM_STORY_FORMTITLE_DISP','نمایش عنوان صفحه؟');
define('_NEWS_AM_STORY_FORMAUTHOR','سازنده ( نام)');
define('_NEWS_AM_STORY_FORMSOURCE','منبع ( لینک)');
define('_NEWS_AM_STORY_FORMTEXT','متن');
define('_NEWS_AM_STORY_FORMTEXT_DESC','ساخت یا ویرایش صفحه');
define('_NEWS_AM_STORY_FORMGROUP','گروه ها');
define('_NEWS_AM_STORY_FORMALIAS','نام مستعار');
define('_NEWS_AM_STORY_FORMACTIF','فعال');
define('_NEWS_AM_STORY_IMPORTANT','مهم');
define('_NEWS_AM_STORY_FORMDEFAULT','پیشفرض');
define('_NEWS_AM_STORY_FORMPREV','صفحه قبلی');
define('_NEWS_AM_STORY_FORMNEXT','صقحه بعدی');
define('_NEWS_AM_STORY_DOHTML','نمایش به صورت Html');
define('_NEWS_AM_STORY_BREAKS','تبدیل خط شکسته فعال');
define('_NEWS_AM_STORY_DOIMAGE','نمایش تصاویر');
define('_NEWS_AM_STORY_DOXCODE','نمایش کدها');
define('_NEWS_AM_STORY_DOSMILEY','نمایش لبخند ها');
define('_NEWS_AM_STORY_SHORT','متن خلاصه');
define('_NEWS_AM_STORY_TITLE','عنوان');
define('_NEWS_AM_STORY_MANAGER','مدیریت اخبار');
define('_NEWS_AM_STORY_FILE','فایل');
define('_NEWS_AM_STORY_ID','شماره');
define('_NEWS_AM_STORY_NUM','وزن');
define('_NEWS_AM_STORY_PAGE','صفحه');
define('_NEWS_AM_STORY_TYPE','نوع');
define('_NEWS_AM_STORY_OWNER','سازنده');
define('_NEWS_AM_STORY_ACTIF','فعال');
define('_NEWS_AM_STORY_DEFAULT','پیشفرض');
define('_NEWS_AM_STORY_ORDER','چیدمان');
define('_NEWS_AM_STORY_ACTION','عملگرها');
define('_NEWS_AM_STORY_VIEW','نمایش');
define('_NEWS_AM_STORY_EDIT','ویرایش');
define('_NEWS_AM_STORY_DELETE','حذف');
define('_NEWS_AM_STORY_SHORTDESC','توضیح خلاصه');
define('_NEWS_AM_STORY_TOPIC','شاخه');
define('_NEWS_AM_STORY_TOPIC_DESC','اگر شاخه ای انتخاب نکنید <br />صفحه شما یک صفحه استاتیک خواهد بود');
define('_NEWS_AM_STORY_STATIC','صفحه استاتیک');
define('_NEWS_AM_STORY_STATICS','صفحات استاتیک');
define('_NEWS_AM_STORY_ALL_ITEMS','تمام صفحه ها و منو ها از تمام شاخه ها');
define('_NEWS_AM_STORY_ALL_ITEMS_FROM','تمام صفحه ها و منو ها از شاخه :');
define('_NEWS_AM_STORY_FILE_DESC','برای اضافه کردن فایل های بیشتر به بخش مدیریت فایل ها مراجعه نمایید');
define('_NEWS_AM_STORY_SUBTITLE','عنوان دوم');
define('_NEWS_AM_STORY_ALL','همه اخبار');
define('_NEWS_AM_STORY_OFFLINE','اخبار منتظر برای تایید');
define('_NEWS_AM_STORY_EXPIRE','اخبار باطل شده');
define('_NEWS_AM_STORY_PEDATE','تنظیم زمان نمایش و باطل شدن');
define('_NEWS_AM_STORY_SETDATETIME','تعیین زمان/تاریخ قرار گرفتن خبر در سایت');
define('_NEWS_AM_STORY_SETEXPDATETIME','تعیین زمان/تاریخ منقضی شدن خبر در سایت');
define('_NEWS_AM_STORY_SLIDE','استفاده در اسلایدشو');
define('_NEWS_AM_STORY_MARQUE','استفاده در مارکیو');
define('_NEWS_AM_STORY_OPTIONS','گزینه ها');
// Tools page
