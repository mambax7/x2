...
// Content page
define('_NEWS_AM_STORY_FORM','Manage Article');
define('_NEWS_AM_STORY_FORMTITLE','Title');
define('_NEWS_AM_STORY_FORMTITLE_DISP','Display page title?');
define('_NEWS_AM_STORY_FORMAUTHOR','Source (Name)');
define('_NEWS_AM_STORY_FORMSOURCE','Source (URL)');
define('_NEWS_AM_STORY_FORMTEXT','Text');
define('_NEWS_AM_STORY_FORMTEXT_DESC','Main story of the page');
define('_NEWS_AM_STORY_FORMGROUP','Groups');
define('_NEWS_AM_STORY_FORMALIAS','Alias (for url)');
define('_NEWS_AM_STORY_FORMACTIF','Online');
define('_NEWS_AM_STORY_IMPORTANT','Important');
define('_NEWS_AM_STORY_FORMDEFAULT','Default');
define('_NEWS_AM_STORY_FORMPREV','Previous link');
define('_NEWS_AM_STORY_FORMNEXT','Next link');
define('_NEWS_AM_STORY_DOHTML','Allow HTML code');
define('_NEWS_AM_STORY_BREAKS','Convert line breaks');
define('_NEWS_AM_STORY_DOIMAGE','Allow Images');
define('_NEWS_AM_STORY_DOXCODE','Allow BBcode');
define('_NEWS_AM_STORY_DOSMILEY','Allow Smilies');
define('_NEWS_AM_STORY_SHORT','Short text');
define('_NEWS_AM_STORY_TITLE','Title');
define('_NEWS_AM_STORY_MANAGER','Article manager');
define('_NEWS_AM_STORY_FILE','File');
define('_NEWS_AM_STORY_ID','ID');
define('_NEWS_AM_STORY_NUM','Weight');
define('_NEWS_AM_STORY_PAGE','Page');
define('_NEWS_AM_STORY_TYPE','Type');
define('_NEWS_AM_STORY_OWNER','Owner');
define('_NEWS_AM_STORY_ACTIF','Active');
define('_NEWS_AM_STORY_DEFAULT','Default');
define('_NEWS_AM_STORY_ORDER','Order');
define('_NEWS_AM_STORY_ACTION','Actions');
define('_NEWS_AM_STORY_VIEW','View');
define('_NEWS_AM_STORY_EDIT','Edit');
define('_NEWS_AM_STORY_DELETE','Delete');
define('_NEWS_AM_STORY_SHORTDESC','Short Desc');
define('_NEWS_AM_STORY_TOPIC','Topic');
define('_NEWS_AM_STORY_TOPIC_DESC','Empty selection will set the article as a Static Page');
define('_NEWS_AM_STORY_STATIC','Static page');
define('_NEWS_AM_STORY_STATICS','Static pages');
define('_NEWS_AM_STORY_ALL_ITEMS','All article/item list');
define('_NEWS_AM_STORY_ALL_ITEMS_FROM','Item list filtered by: ');
...
define('_NEWS_AM_STORY_MARQUE','Set as margue');
