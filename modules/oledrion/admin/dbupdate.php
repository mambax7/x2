 ...
 * @since 2.3.2011.08.03
 */
$tableName = $xoopsDB->prefix('oledrion_products');
if(!oledrion_fieldExists('product_property1', $tableName)) {
    oledrion_addField('product_property1 varchar(255) NOT NULL', $tableName);
    $wasUpdated = true;
}

if(!oledrion_fieldExists('product_property2', $tableName)) {
    oledrion_addField('product_property2 varchar(255) NOT NULL', $tableName);
    $wasUpdated = true;
}

if(!oledrion_fieldExists('product_property3', $tableName)) {
    oledrion_addField('product_property3 varchar(255) NOT NULL', $tableName);
    $wasUpdated = true;
}

if(!oledrion_fieldExists('product_property4', $tableName)) {
    oledrion_addField('product_property4 varchar(255) NOT NULL', $tableName);
    $wasUpdated = true;
}

if(!oledrion_fieldExists('product_property5', $tableName)) {
    oledrion_addField('product_property5 varchar(255) NOT NULL', $tableName);
    $wasUpdated = true;
}
