...
CREATE TABLE `oledrion_commands` (
  ...
  `cmd_total` double(10,2) NOT NULL,
...
CREATE TABLE `oledrion_vat` (
  ...
  `vat_country` varchar(3) NOT NULL COMMENT 'ISO Country Code',
  PRIMARY KEY  (`vat_id`),
...
CREATE TABLE `oledrion_discounts` (
  ...
  `disc_price_amount_amount` double(10,2) NOT NULL COMMENT 'Montant ou pourcentage de réduction sur le prix',
